...
<body>
  <nav class="bg-zinc-200 shadow-lg w-full flex justify-between items-center h-24 px-8">
    <div class="w-1/6 h-full flex items-center">
      <h2 class="text-red-600 font-extrabold text-5xl">QenA</h2>
    </div>
    <div class="w-4/6 h-full flex items-center">
      <div class="w-full relative m-4 rounded-lg">
        <form action="/">
          <input
            type="text"
            name="search"
            class="h-14 w-full pl-5 pr-20 rounded-lg z-0 bg-zinc-50 focus:bg-zinc-100 focus:shadow focus:outline-none"
    ...
    <div class="w-1/6 flex items-center justify-end">
      <a href="/" class="px-4 py-3 rounded bg-blue-500 text-zinc-100 hover:bg-blue-600">Ask Question</a>
    </div>
  </nav>
    <div class="w-60 h-full col-span-1 shadow-md bg-white px-1 absolute">
